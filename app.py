...
class Ledger(db.Model):
    ...
    weight = db.Column(db.Float(precision="12,3"), nullable=False)
    rate = db.Column(db.Float(precision="12,3"), nullable=False)
    totalPrice = db.Column(db.Float(precision="12,3"), nullable=False)
...
class Cash(db.Model):
    ...
    name = db.Column(db.String(100), nullable=False)
    inOut = db.Column(db.String(15), nullable=False)
    price = db.Column(db.Float(precision="12,3"), nullable=False)
    dateAdded = db.Column(db.String(50), nullable=False)
